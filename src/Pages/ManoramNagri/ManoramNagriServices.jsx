...
const ManoramNagriServices = () => {
  ...
  const handleBookNowClick = () => {
    if (isAuthenticated()) {
      ...
      setRedirectAfterLogin('/manoram-nagri-services');
      navigate('/login');
    }
  };
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section - Responsive height and padding adjustments */}
      ...
      {/* Plot Layout Section - Responsive scaling and padding */}
      ...
      {/* Features Section - Responsive grid and card layout */}
      ...
      {/* Book Now Button - Responsive sizing and hover effects */}
      <section className="py-8 sm:py-12 bg-white">
...
export default ManoramNagriServices;